...
def tree_provider():
    ...
    oak = {
        ...
        'member_of': [],
        'subordinate_arrays': [],
        'matches': {'exact': ['https://id.erfgoed.net/thesauri/soorten/297']},
    }
...
class TestRDFDumperTrees:
    ...
    def test_dump_larch_to_rdf(self, tree_provider):
        ...
        assert (
            ...
            SKOS.definition,
            Literal(
                '<p xml:lang="en">Trees as used by Monthy Python.</p>', datatype=RDF.HTML
            ),
        ) in graph_dump
    ...
    def test_dump_chestnut_to_rdf(self, tree_provider):
        ...
        assert (
            chestnut,
            SKOS.altLabel,
            Literal('De Paardekastanje', lang='nl'),
        ) in graph_dump
        assert (
            chestnut,
            SKOS.prefLabel,
            Literal('The Chestnut', lang='en'),
        ) in graph_dump
        ...
        assert (
            chestnut,
            SKOS.definition,
            Literal('A different type of tree.', lang='en'),
        ) in graph_dump
